...
urlpatterns = patterns('',
    ...
    url(r'^recommended.html$', direct_to_template, {'template':'recommended.html'}, name='recommended'),
    url(r'^clients.html$', direct_to_template, {'template':'clients.html'}, name='clients'),
    url(r'^partners.html$', direct_to_template, {'template':'partners.html'}, name='partners'),
    ...
    url(r'^map.html$', direct_to_template, {'template':'map.html'}, name='map'),
